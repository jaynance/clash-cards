...
if (empty($_SESSION['is_admin'])) {
    ...
    <div class="box">
        <?php if ($clanName !== ''): ?>
        <div class="clan-banner"><span class="clan-label">Clan</span><?= htmlspecialchars($clanName, ENT_QUOTES, 'UTF-8') ?></div>
        <?php endif; ?>
        <h1>Player Admin</h1>
...
<body>
<?php if ($clanName !== ''): ?>
<div class="clan-banner-main"><span class="clan-label">Clan</span><?= h($clanName) ?></div>
<?php endif; ?>
