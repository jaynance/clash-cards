...
<section>
    ...
    <div class="optimizer-summary">
        ...
        <div class="optimizer-card">
            ...
            <span>needed cards fulfilled</span>
        </div>
        <div class="optimizer-card">
    ...
    <div class="player-meta">
        <?= (int)$optimization['fulfilled_units'] ?> of <?= (int)$optimization['total_need_units'] ?> needed card units can be covered by current extras.
    </div>
